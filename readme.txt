...
I love GraphQL for a lot of different reasons. I didn't use subscriptions or mutations for this example, but I'm choosing to move forward to learning gRPC in Go, because I'm expecting a job interview in this soon, I understand graphQL principles, and need to try different use cases to get used to Go language/syntax.
